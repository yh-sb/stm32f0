if(NOT DEFINED OPENOCD_PARAMS)
    message(FATAL_ERROR "OPENOCD_PARAMS is not defined.\n"
        "Example: \"set(OPENOCD_PARAMS -f interface/stlink-v2.cfg transport select hla_swd -f target/stm32f0x.cfg)\"")
endif()
...
add_custom_target(erase
    COMMAND openocd ${OPENOCD_PARAMS} -c "init; halt; stm32f0x mass_erase 0; exit"
    USES_TERMINAL
)
